...
def main():
    ...
    seccion("FACTURACION A IRLANDA: REVISION DE CASILLAS")
    print("  Al facturar sin IVA a un cliente irlandes (B2B), el servicio no")
    print("  esta sujeto en Espana por reglas de localizacion y el cliente")
    print("  autoliquida. Eso se declara en:")
    print("    - casilla 59 del 303  'Entregas intracomunitarias de bienes")
    print("      y servicios'")
    print("    - modelo 349, declaracion recapitulativa")
    print("    - previa alta en el ROI y NIF-IVA validado en VIES")
    print()
    print("  En las cuatro autoliquidaciones presentadas de 2026:")
    print("    casilla 59  (intracomunitarias)  VACIA en las cuatro")
    print("    casilla 60  (exportaciones)      VACIA en las cuatro")
    print("    casilla 120 (no sujetas)         VACIA en las cuatro")
    print(f"    casilla 122 (ISP interior)       {eur(SL_VENTAS_1S)} en la SL")
    print()
    print("  La casilla 122 es para operaciones INTERIORES con inversion del")
    print("  sujeto pasivo (construccion, chatarra, moviles, inmuebles), no")
    print("  para servicios intracomunitarios.")
    print()
    print("  >> Si esos 50.131,33 EUR ya eran facturacion a Irlanda, estan en")
    print("     la casilla equivocada y falta presentar el modelo 349. No")
    print("     cambia el IVA a pagar, pero el 349 se cruza via VIES con lo")
    print("     que declare el cliente irlandes. VERIFICALO CON TU ASESOR.")
    print()
    print("  >> Si la facturacion a Irlanda empieza ahora en septiembre,")
    print("     asegurate del alta en el ROI ANTES de emitir: sin NIF-IVA")
    print("     en VIES no puedes facturar sin IVA y tendrias que repercutir")
    print("     el 21%.")
